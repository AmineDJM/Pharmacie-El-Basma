...
export function CategoryCard({
  ...
  return (
    ...
    >
      <div className={cn('absolute -right-8 -top-8 h-24 w-24 rounded-full opacity-10 blur-2xl transition-opacity group-hover:opacity-20', a.dot)} />
      ...
      {category._count && (
        <span className={cn('mt-auto text-xs font-semibold', a.text)}>
