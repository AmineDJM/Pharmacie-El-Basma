...
export default async function AdminDashboard() {
  let counts = { products: 0, categories: 0, brands: 0, articles: 0, reviews: 0, unread: 0, subscribers: 0 };
  let recentMessages: { id: string; name: string; subject: string; createdAt: Date; read: boolean }[] = [];

  try {
    const [products, categories, brands, articles, reviews, unread, subscribers, messages] = await Promise.all([
    ...
    counts = { products, categories, brands, articles, reviews, unread, subscribers };
  ...
  const quickActions = [
    ...
    { label: 'Ajouter un avis', href: '/admin/avis/nouveau', icon: Star },
